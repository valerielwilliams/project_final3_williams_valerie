...
secretBurger.addEventListener('dblclick', function () {   //This listens for a double-click on the Bob's Burgers logo.
    ...
    newParagraph.innerHTML = "<h2 class='secret'>Secret Menu</h2><h3 class='secretitem'>Bob's Secret Burger<span class='secretprice'>$6</span></h3>'<p class='secretdescription'>All-beef patty topped with Bob's Secret Sauce</p>"; //completes the sentence with 'for a good day'.
    document.getElementsByTagName('section')[3].appendChild(newParagraph);
});
